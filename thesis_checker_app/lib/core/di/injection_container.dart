...
Future<void> setupLocator() async {
  ...
  getIt.registerSingleton<ApplicationPreferencesRepository>(
      ApplicationPreferencesRepository(getIt<SharedPreferences>()));

  // init BLoC's and Cubit's
  getIt.registerSingleton<ThemeCubit>(ThemeCubit(
      getIt<ApplicationPreferencesRepository>()));
